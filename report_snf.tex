...
\subsection{Multiscale inverse problems}

\subsection{Statistical inference of multiscale SDEs}

\subsection{Probabilistic numerical methods for forward and inverse problems}

\subsection{Discontinuous Galerkin discretization of elliptic PDEs}

\subsection{Stabilized explicit multirate methods for stiff equations}

\subsection{Novel cell problems for reduced resonance errors in the FE-HMM}
